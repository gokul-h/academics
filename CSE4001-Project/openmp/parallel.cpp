...
#define num 15       // Number of Training Images to Read
#define test_num 15  // Number of Testing Images to Read
#define MINIBATCH 15 // Must divide into SAMPLE_SIZE evenly
...
void fileload()
{
    string IMAGE_FILE_NAME = "./Datasets/t10k-images.idx3-ubyte";    // Training Images Data File
    string LABEL_FILE_NAME = "./Datasets/t10k-labels.idx1-ubyte";    // Training Labels Data File
    string TEST_IMAGE_FILE_NAME = "./Datasets/t10k-images.idx3-ubyte"; // Testing Images Data File
    string TEST_LABEL_FILE_NAME = "./Datasets/t10k-labels.idx1-ubyte";    // Testing Labels Data File
...
int main(int argc, char const *argv[])
{
    ...
    cout << "accuracy is ";
    float acc = ((float) count/(float) test_num)*100;
    cout<<acc<<"\n";
